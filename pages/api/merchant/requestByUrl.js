...
export default async function handler(req,res)
{
    ...
    const { payerRef,envName, returnUrl } = req.body;
	...
	if(accessToken != null)
	{
		...
		const endPoint = `${apiUrl}/business/requestbyurl?payerref=${payerRef}&formtype=form1099&returnurl=${returnUrl}&cancelurl=${returnUrl}`;
